	...
	return (
		<>
			<div className='hidden md:flex md:flex-row'>
				<div className='hidden md:flex md:flex-row relative w-[20vw] bg-gradient-to-l from-black to-transparent h-[100vh]'>
					<div className='absolute top-72 left-6 '>
						<div className='glb text-white transform -rotate-90 '>
							GALLERY
						</div>
					</div>
				</div>
								...
								<div className='flex flex-row'>
									...
									>
										...
										>
											...
											>
												<figure
													className='relative shadow-lg hover:border-2 border-yellow-500 hover:-translate-y-3 hover:transition hover:ease-in-out '
													onMouseEnter={() => {
														setCh(
															true
														);
										...
										>
											...
											>
												...
												>
													<Image
														className='w-full  bg-white'
														src='https://ipfs.io/ipfs/QmQLSbRxdzYWixFKxzr51RkS7dNGvnaoMbcSDRnpcTvfa7'
														width='1310'
														height='873'
														alt={
															"pri"
			...
			<div className='md:hidden '>
				<GalleryCard
					backgroundImageUrl={
						"https://ipfs.io/ipfs/QmYxeRFKCizpCct16mJXRH3MqhLekwNqed78VAei6udjs7"
					}
					matchDetail={"CHAMPIONS LEAGUE"}
					mt='mt-16'
					ilink='/gallery/cleague'
				/>
				<GalleryCard
					backgroundImageUrl={
						"https://ipfs.io/ipfs/QmfZJNgr5fV7sMNPgKc1AMybZo6iAFJC7v6FxetX87QU5F"
					}
					matchDetail={"COPA DEL REY"}
					mt='mt-2'
					ilink={"/gallery/cleague"}
				/>
				<GalleryCard
					backgroundImageUrl={
						"https://ipfs.io/ipfs/QmaAHgDuqx3LQSUKTNktvsD3xaDn5A7jGCQ7e3BnDobQwM"
					}
					matchDetail={"LA LIGA"}
					mt={"mt-2"}
					ilink={"/gallery/cleague"}
				...
				<GalleryCard
					backgroundImageUrl={
						"https://ipfs.io/ipfs/QmQLSbRxdzYWixFKxzr51RkS7dNGvnaoMbcSDRnpcTvfa7"
					}
					matchDetail={"PERSONAL"}
					mt={"mt-2"}
					ilink={""}
				/>
			</div>
